...
Mat src, src_gray, src_filtered, src_equal, src_thred, src_morph, dst;
...
void main(void)
{
	...
	while (true)
	{
		...
		if (key == 27)										break;
			...
			plotHist(src_gray, "histplot_src", src_gray.cols, src_gray.rows); resizeWindow("histplot_src", Size(800, 800));
